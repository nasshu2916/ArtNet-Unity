    ...
    public class BinaryDmxHeaderTest
    {
        ...
        public void SerializeHeaderTest()
        {
            ...
            expected = new byte[]
            {
                ...
                0x02, // Version
                0x01, // CompressType
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 // ReservedBuffer
            };
    ...
    public class BinaryDmxTest
    {
        private static IEnumerable<TestCaseData> TestSerializeData
        {
            get
            {
                ...
                {
                    0xFF, 0x44, 0x4D, 0x58, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                    0x00, // Headers
                ...
                {
                    0xFF, 0x44, 0x4D, 0x58, 0x02, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                    0x00, // Headers
                ...
                {
                    0xFF, 0x44, 0x4D, 0x58, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        private static IEnumerable<TestCaseData> TestDeserializeData
        {
            get
            {
                yield return new TestCaseData(
                    new byte[]
                    {
                        0xFF, 0x44, 0x4D, 0x58, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x00, 0x00, // Headers
                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x00, 0x00, 0x05, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        private static IEnumerable<TestCaseData> TestInvalidDeserializeData
        {
            get
            {
                yield return new TestCaseData(
                    new byte[]
                    {
                        0xF0, 0x44, 0x4D, 0x58, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x00, 0x00, // Headers
                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x00, 0x00, 0x05, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
                    }
